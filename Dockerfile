...
RUN --mount=type=cache,target=/root/.cache/uv \
    uv sync --frozen --no-install-project --no-dev --extra redis --extra metrics --extra docs --extra outbound --extra mcp --extra jwt

COPY README.md ./
COPY src ./src
RUN --mount=type=cache,target=/root/.cache/uv \
    uv sync --frozen --no-dev --extra redis --extra metrics --extra docs --extra outbound --extra mcp --extra jwt
